...
$(document).ready(function() {
	...
	$("#addChampButton").click(function(e) {
		...
		$.AJAX("../etc/championInfo.php", function(text, readyState, status, champion) {
			...
			var itemTooltipOptions = {
				showDelay : 500,
				hideDelay: 250,
				dontHideWhileHoveringTooltip: 1,
				hideAnimation : {
					opacity : "hide"
				},
				showAnimation : {
			...
			$("#" + id + " .ChampionItem1").Tooltip("#" + id + " .ChampionItem1Tooltip", null, itemTooltipOptions);
			$("#" + id + " .ChampionItem2").Tooltip("#" + id + " .ChampionItem2Tooltip", null, itemTooltipOptions);
			$("#" + id + " .ChampionItem3").Tooltip("#" + id + " .ChampionItem3Tooltip", null, itemTooltipOptions);
			$("#" + id + " .ChampionItem4").Tooltip("#" + id + " .ChampionItem4Tooltip", null, itemTooltipOptions);
			$("#" + id + " .ChampionItem5").Tooltip("#" + id + " .ChampionItem5Tooltip", null, itemTooltipOptions);
			$("#" + id + " .ChampionItem6").Tooltip("#" + id + " .ChampionItem6Tooltip", null, itemTooltipOptions);
			$("#" + id + " .ChampionTrinket").Tooltip("#" + id + " .ChampionTrinketTooltip", null, itemTooltipOptions);
